...
const translations = {
    en: {
        ...
        '發送驗證碼': 'Send Code',
        '重新發送': 'Resend',
        '請輸入6位數驗證碼': 'Please enter 6-digit verification code',
    ...
    es: {
        ...
        '使用 Google 註冊': 'Registrarse con Google',
        
        // Email Verification
        '驗證碼': 'Código de Verificación',
        '發送驗證碼': 'Enviar Código',
        '重新發送': 'Reenviar',
        '請輸入6位數驗證碼': 'Por favor ingrese código de verificación de 6 dígitos',
    ...
    de: {
        ...
        // Footer
        '點擊「生成圖片」開始創作': 'Klicken Sie auf "Bild generieren", um mit dem Erstellen zu beginnen',
        ...
        '使用 Google 登入': 'Mit Google anmelden',
        ...
        '立即登入': 'Jetzt anmelden',
        '使用 Google 註冊': 'Mit Google registrieren',
        
        // Email Verification
        '驗證碼': 'Bestätigungscode',
        '發送驗證碼': 'Code Senden',
        '重新發送': 'Erneut Senden',
        '請輸入6位數驗證碼': 'Bitte geben Sie den 6-stelligen Bestätigungscode ein',
    ...
    ja: {
        ...
        '立即登入': '今すぐログイン',
        '使用 Google 註冊': 'Googleで登録',
        
        // Email Verification
        '驗證碼': '認証コード',
        '發送驗證碼': 'コード送信',
        '重新發送': '再送信',
        '請輸入6位數驗證碼': '6桁の認証コードを入力してください',
